...
CREATE TABLE IF NOT EXISTS alumni (
    ...
    CONSTRAINT valid_degree_program CHECK (degree_program IN ('Film Production', 'Screenwriting', 'Animation', 'Documentary', 'Television'))
);
...
CREATE TABLE IF NOT EXISTS projects (
    ...
    CONSTRAINT valid_project_type CHECK (type IN ('Feature Film', 'Short Film', 'TV Series', 'TV Movie', 'Web Series', 'Documentary', 'Animation'))
);

-- Project streaming platforms (many-to-many)
CREATE TABLE IF NOT EXISTS project_streaming_platforms (
...
CREATE TABLE IF NOT EXISTS achievements (
    ...
    CONSTRAINT valid_achievement_type CHECK (type IN ('Award', 'Production Credit', 'Festival Selection', 'Review/Reception', 'Industry Recognition'))
);
...
CREATE INDEX IF NOT EXISTS idx_alumni_degree_program ON alumni(degree_program);
CREATE INDEX IF NOT EXISTS idx_projects_release_date ON projects(release_date);
CREATE INDEX IF NOT EXISTS idx_projects_type ON projects(type);
CREATE INDEX IF NOT EXISTS idx_achievements_alumni_id ON achievements(alumni_id);
