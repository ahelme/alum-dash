...
CREATE TABLE alumni (
    ...
    degree_program VARCHAR(50) NOT NULL,  -- Changed from enum to varchar
    email VARCHAR(255),
    linkedin_url TEXT,
    imdb_url TEXT,
    website TEXT,
...
CREATE TABLE projects (
    ...
    release_date DATE,
    type VARCHAR(50) NOT NULL,  -- Changed from enum to varchar
    imdb_id VARCHAR(20),
    tmdb_id VARCHAR(20),
    poster_url TEXT,
    synopsis TEXT,
...
CREATE INDEX idx_achievements_alumni_id ON achievements(alumni_id);
