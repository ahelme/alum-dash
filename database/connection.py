...
class Alumni(Base):
    ...
    degree_program = Column(SQLEnum(DegreeProgram, values_callable=lambda obj: [e.value for e in obj], create_constraint=False, native_enum=False), nullable=False)
...
class Project(Base):
    ...
    type = Column(SQLEnum(ProjectType, values_callable=lambda obj: [e.value for e in obj], create_constraint=False, native_enum=False), nullable=False)
...
class Achievement(Base):
    ...
    type = Column(SQLEnum(AchievementType, values_callable=lambda obj: [e.value for e in obj], create_constraint=False, native_enum=False), nullable=False)
    title = Column(String(200), nullable=False)
...
class DataSource(Base):
    ...
    type = Column(SQLEnum(DataSourceType, values_callable=lambda obj: [e.value for e in obj], create_constraint=False, native_enum=False), nullable=False)
